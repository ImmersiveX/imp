...
public class EditActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.schedule_activity_edit);
        init();
    }
    ...
    private void checkMode(){
        ...
        if(mode == ScheduleFragment.REQUEST_EDIT){
            loadScheduleData();
        ...
        switch (v.getId()){
            case R.id.submit_btn:
                if(mode == ScheduleFragment.REQUEST_ADD){
                    ...
                    finish();
                    Toast updated = Toast.makeText(this, "Added", Toast.LENGTH_SHORT);
                    updated.setGravity(Gravity.CENTER_HORIZONTAL,0,430);
                    updated.show();
                }
                else if(mode == ScheduleFragment.REQUEST_EDIT){
                    inputDataProcessing();
                    Intent i = new Intent();
                    ArrayList<Schedule> schedules = new ArrayList<Schedule>();
                    schedules.add(schedule);
                    ...
                    finish();
                    Toast updated = Toast.makeText(this, "Saved", Toast.LENGTH_SHORT);
                    updated.setGravity(Gravity.CENTER_HORIZONTAL,0,430);
                    updated.show();
                }
                break;
            case R.id.delete_btn:
                ...
                finish();
                Toast updated = Toast.makeText(this, "Deleted", Toast.LENGTH_SHORT);
                updated.setGravity(Gravity.CENTER_HORIZONTAL,0,430);
                updated.show();
                break;
        }
